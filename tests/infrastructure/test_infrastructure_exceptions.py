...
class TestInfrastructureError:
    """Test cases for InfrastructureError."""
...
class TestDataPersistenceError:
    """Test cases for DataPersistenceError."""
...
class TestCommandParsingError:
    """Test cases for CommandParsingError."""
...
class TestServiceConfigurationError:
    """Test cases for ServiceConfigurationError."""
...
class TestResourceCleanupError:
    """Test cases for ResourceCleanupError."""
